...
- **siteName**: Nama portal berita (akan replace "Kabar Purwasuka")
- **email**: Email portal (akan replace "KabarPurwasuka@gmail.com")
...
2. Untuk setiap dari 34 site:
   - Copy folder **Kabar Purwasuka** → folder baru
...
|---|---|
| `Kabar Purwasuka` | `siteName` dari config |
| `indonesiadaily` | `siteName` (tanpa spaces) |
| `indonesiadaily` | `socialHandle` |
| `KabarPurwasuka@gmail.com` | `email` |
