...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = "Indonesia Daily"; New = "Indonesia Daily" },
            @{ Old = "IndonesiaDaily"; New = "IndonesiaDaily" },
            @{ Old = "indonesiadaily"; New = "indonesiadaily" },
            # Social media links
            @{ Old = "https://twitter.com/indonesiadaily"; New = "https://twitter.com/indonesiadaily" },
            @{ Old = "https://facebook.com/indonesiadaily"; New = "https://facebook.com/indonesiadaily" },
            @{ Old = "https://instagram.com/indonesiadaily"; New = "https://instagram.com/indonesiadaily" },
            @{ Old = "https://youtube.com/@indonesiadaily"; New = "https://youtube.com/@indonesiadaily" },
            @{ Old = "https://linkedin.com/company/indonesiadaily"; New = "https://linkedin.com/company/indonesiadaily" },
            # Email
            @{ Old = "indonesiadaily@gmail.com"; New = "indonesiadaily@gmail.com" },
            # Logo references
            @{ Old = 'alt="IndonesiaDaily"'; New = 'alt="IndonesiaDaily"' }
        )
...
foreach ($file in $cssFiles) {
    try {
        ...
        # Color replacements
        $colorReplacements = @(
            @{ Old = "#FFCC00"; New = "#0F766E" },          # Primary: kuning -> hijau
            @{ Old = "#ffcc00"; New = "#0F766E" },
            @{ Old = "rgb(255, 204, 0)"; New = "rgb(6, 95, 70)" },
            @{ Old = "#31404B"; New = "#134E4A" },          # Secondary: abu -> biru
            @{ Old = "#1E2024"; New = "#7F1F1F" },          # Dark: hitam -> darkgreen
            # Additional color mappings if needed
            @{ Old = "#1e2024"; New = "#7F1F1F" }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""indonesiadaily"""; New = """name"": ""indonesiadaily""" },
            @{ Old = """name"": ""indonesiadaily-article-generator"""; New = """name"": ""indonesiadaily-article-generator""" }
        )
...
$newColors = @("#0F766E", "#7F1F1F", "#134E4A")
$colorFound = @{}
